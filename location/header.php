             ...
             <ul id="menu-top-menu">
                 ...
                 <li class="menu-item-has-children">
                     ...
                     <ul class="sub-menu" style="display: none;">
                         <li><a href="http://localhost/cjd/tours/ceylon/">Ceylon Highlights</a></li>
                         <li><a href="http://localhost/cjd/tours/general">General</a></li>
                         <li><a href="http://localhost/cjd/tours/wildlife">Wildlife</a></li>
                         <li><a href="http://localhost/cjd/tours/adventure">Adventure</a></li>
                         <li><a href="http://localhost/cjd/tours/cultural">Cultural</a></li>
                         <li><a href="http://localhost/cjd/tours/budget">Budget</a></li>
                     </ul>
                 </li>
             </ul>
         </div>
                                 ...
                                 <div class="main-menu-social-media-mobile-container">
                                     <div class="main-menu-mobile-container">
                                         <ul id="main-menu" class="">
                                             ...
                                             <li><a href="http://localhost/cjd/contact_us.php">Contact Us</a></li>

                                             <!-- Mobile Tour Cards -->
                                             <li class="mobile-tour-cards">
                                                 <h3 style="margin: 20px 0 15px; color: #333; text-align: center;">Our Tours</h3>
                                                 <div class="tour-cards-grid">
                                                     <a href="http://localhost/cjd/tours/ceylon/" class="tour-card">
                                                         <div class="card-content">
                                                             <i class="fas fa-landmark"></i>
                                                             <h4>Ceylon Highlights</h4>
                                                         </div>
                                                     </a>
                                                     <a href="http://localhost/cjd/tours/general" class="tour-card">
                                                         <div class="card-content">
                                                             <i class="fas fa-globe-asia"></i>
                                                             <h4>General</h4>
                                                         </div>
                                                     </a>
                                                     <a href="http://localhost/cjd/tours/wildlife" class="tour-card">
                                                         <div class="card-content">
                                                             <i class="fas fa-paw"></i>
                                                             <h4>Wildlife</h4>
                                                         </div>
                                                     </a>
                                                     <a href="http://localhost/cjd/tours/adventure" class="tour-card">
                                                         <div class="card-content">
                                                             <i class="fas fa-mountain"></i>
                                                             <h4>Adventure</h4>
                                                         </div>
                                                     </a>
                                                     <a href="http://localhost/cjd/tours/cultural" class="tour-card">
                                                         <div class="card-content">
                                                             <i class="fas fa-dharmachakra"></i>
                                                             <h4>Cultural</h4>
                                                         </div>
                                                     </a>
                                                     <a href="http://localhost/cjd/tours/budget" class="tour-card">
                                                         <div class="card-content">
